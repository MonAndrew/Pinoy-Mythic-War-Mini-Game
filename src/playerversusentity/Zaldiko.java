 ...
 * @author junwe
 */
public class Zaldiko extends CharacterStatsBase{
    
    public Zaldiko(){
        super("Zaldiko", 1500, 300);
    }
    ...
    public void supportSkill(){
        ...
        System.out.println(name + " used Ako si Zaldiko and healed for " + healAmount + " HP!" + "| Updated HP: " + currentHealth);
