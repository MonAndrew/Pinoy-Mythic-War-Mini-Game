 ...
 * @author junwe
 */
public class Zak_Rebirto extends CharacterStatsBase{
    
    public Zak_Rebirto(){
        super("Zak Rebirto", 1500, 300);
    }
    ...
    public void supportSkill(){
        ...
        System.out.println(name + " used Ako si Zak and healed for " + healAmount + " HP!" + "| Updated HP: " + currentHealth);
